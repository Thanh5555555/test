    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          {{-- Task List --}}
          <li class="nav-item {{ Route::currentRouteName() == 'admin.tasks.index' ? 'menu-open' : '' }}">
            <a href="#" class="nav-link {{ Route::currentRouteName() == 'admin.tasks.index' ? 'active' : '' }}">
              <i class="nav-icon fas fa-tachometer-alt"></i>
              <p>
                {{ __('message.task_list') }}
              </p>
            </a>
          </li>
